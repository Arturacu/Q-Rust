...
//! heuristic (Davis et al. 2020, *Towards Optimal Topology Aware Quantum
//! Circuit Synthesis*, IEEE QCE 2020).
//!
//! Currently returns `None` for all inputs. Callers that need 1-qubit
//! synthesis should use [`crate::transpiler::synthesis::zyz::ZyzSynthesizer`];
//! for 2-qubit synthesis, use [`crate::transpiler::synthesis::kak::KakSynthesizer`].
